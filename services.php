    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                        <div class="services-box services-sb">
                            <img src="assets/images/social-img.png" class="img-fluid" alt="Content and Social">
                            <h2>CONTENT & SOCIAL</h2>
                            <p>MARTY will consistently produce relevant content in order to retain organic visitors while also supporting various marketing efforts to acquire new customers.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="services-box services-st">
                            <img src="assets/images/strategy.png" class="img-fluid" alt="Content and Social">
                            <h2>STRATEGY</h2>
                            <p>MARTY will help strategize digital marketing plan based on a detailed market research and competitive analysis.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="services-box services-design">
                            <img src="assets/images/web-design.png" class="img-fluid" alt="Content and Social">
                            <h2>WEB DESIGN</h2>
                            <p>MARTY’s web package begins with strategy and user experience phases and then finishes with a complete user interface design and copywriting.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="services-box services-pd">
                            <img src="assets/images/print-design.png" class="img-fluid" alt="Content and Social">
                            <h2>PRINT DESIGN</h2>
                            <p>MARTY offers custom print design services and production, including business cards, postcards, flyers, and brochures and large format printing.</p>
                        </div>
                    </div>
                </div>
            </div>
